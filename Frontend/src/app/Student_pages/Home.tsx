          ...
          <div className="flex items-center justify-between mb-8 px-2 w-full">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="w-10 h-10 rounded-2xl bg-red-50 flex items-center justify-center text-red-500 shadow-sm border border-red-100 active:scale-95 transition-transform"
                title="Гарах"
              >
                <LogOut size={20} />
              </button>
